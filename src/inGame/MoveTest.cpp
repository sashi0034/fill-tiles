...
inGame::MoveTest::MoveTest(SDL_Renderer* renderer) {
    m_Renderer = renderer;
...
void inGame::MoveTest::Test() {
    std::cout << "Nemui Nemui." << std::endl;
}

void inGame::MoveTest::Update(int deltaTime, const Uint8* state) {
...
void inGame::MoveTest::changeFrame(int deltaTime) {
